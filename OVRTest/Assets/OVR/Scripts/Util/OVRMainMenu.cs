...
public class OVRMainMenu : MonoBehaviour
{
	...
	/// <summary>
	/// The key that resets the head position.
	/// </summary>
	public KeyCode	ResetKey		= KeyCode.LeftControl;
	private OVRDisplay ovrdevice;
	...
	{    
		...
		//HERE set up ovrdevice
		//ovrdevice = GameObject.Find (OVRDisplay).GetComponent<OVRDisplay> ();
